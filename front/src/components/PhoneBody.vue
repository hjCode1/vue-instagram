<template>
    <div id="feed" v-dragscroll.y="true">
        ...
        <div v-if="step === 2">
            <div class="selected_img" :class="selectedFilter" :style="{ backgroundImage: 'url(' + image + ')' }"></div>
        ...
        <div v-if="step === 3">
            ...
            <div class="caption_container">
                <textarea :value="value" @input="$emit('input', $event.target.value)" class="caption_input" placeholder="Write a caption" type="text"></textarea>
            </div>
        </div>
    </div>
</template>
